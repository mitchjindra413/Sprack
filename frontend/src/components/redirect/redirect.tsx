...
const Redirect = () => {
   ...
   useEffect(() => {
     if(searchParams?.get('code')){
       ...
       const tokenEndpoint = 'http://localhost:8079/oauth2/token';
   ...
   useEffect(() => {
     if(!searchParams?.get('code')){
       ...
       const link = `http://localhost:8079/oauth2/authorize?response_type=code&client_id=${client}&scope=openid&redirect_uri=${redirectUri}&code_challenge=${codeChallenge}&code_challenge_method=S256`;
